    ...
    <div className="h-screen w-screen flex flex-col">
      ...
      <div className="grid grid-cols-3 gap-6 m-72 mt-20">
        {cards.slice(0, 3).map((card, index) => (
          <div key={index} className="bg-white  rounded-3xl p-6  flex flex-col items-left text-left w-[284px] border border-gray-100">
        ...
        <div className="col-span-3 flex justify-center gap-6">
          {cards.slice(3).map((card, index) => (
            <div key={index} className="bg-white rounded-3xl p-6 flex flex-col items-left w-[284px] text-left border border-gray-100">
