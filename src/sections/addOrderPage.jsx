    ...
    <div className="max-w-3xl mx-auto p-4 sm:p-6 font-sans">
      <header className="mb-6">
        <button 
          ...
          aria-label="Go back"
        >
          <span className="mr-2">←</span> Adding Order
        </button>
      </header>
      ...
      <main>
        <form onSubmit={handleSubmit} className="flex flex-col space-y-6">
          <section>
            <h2 className="text-base font-medium mb-2">Upload order file</h2>
            <div 
          ...
          <section>
            <h2 className="text-base font-medium mb-2">Paste order details</h2>
            <textarea
              value={orderDetails}
              onChange={handleOrderDetailsChange}
              placeholder="Copy-paste your order details here"
              className="w-full border border-gray-300 rounded-lg p-3 text-sm resize-y focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              rows={6}
              aria-label="Order details"
            />
            <p className="text-sm text-gray-600 mt-2">
              Don't know what to enter? <a href="#" onClick={handleFillFormClick} className="text-blue-600 hover:underline">Fill up the order form</a>
            </p>
          </section>
