        ...
        <form onSubmit={handleSubmit} className="flex flex-col space-y-6">
          <section>
            <div className='flex flex-col'>
                ...
                <select className='w-full max-w-xl p-2 rounded-lg border border-gray-200 mb-2 text-gray-400'>
                    <option value=''>Select your order</option>
                    <option value='1'>Hello</option>
                </select>
                <label className='font-medium mb-2'>Border</label>
                <select className='w-full max-w-xl p-2 rounded-lg border border-gray-200 mb-2 text-gray-400'>
                    <option value=''>Select your order</option>
                    <option value='1'>Hello</option>
                </select>
                <label className='font-medium mb-2'>PAPS Number</label>
                <select className='w-full max-w-xl p-2 rounded-lg border border-gray-200 mb-2 text-gray-400'>
                    <option value=''>Select your order</option>
                    <option value='1'>Hello</option>
                </select>
                <label className='font-medium mb-2'>Broker</label>
                <select className='w-full max-w-xl p-2 rounded-lg border border-gray-200 mb-2 text-gray-400 bg-white'>
                    <option value=''>Select your order</option>
                    <option value='1'>Hello</option>
                </select>
