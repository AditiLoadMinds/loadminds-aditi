                ...
                <div className=" flex justify-end">
                        <button
                            ...
                            if (window.confirm("Are you sure you want to delete this POD? This action cannot be undone.")) {
                                ...
                                navigate('/orders', { state: { message: 'POD deleted successfully' } });
                            }
                            }}
                            className="flex items-center gap-2 border border-red-600 text-red-600 px-4 py-2 rounded-lg hover:bg-red-600 hover:text-white transition"
                        >
